/*
Taken verbatim from https://github.com/fasterthanlime/rue/
For testing purposes due to similarity and their tutorial about strace
Will be modifying in the near future
 */
